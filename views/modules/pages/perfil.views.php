...
<?php endif; ?>
<?php if (isset($_GET["id"]) AND strpos($_GET["id"], "img-exito") != false): ?>
<div>
	<div class="alert alert-success" role="alert">
	  <div class="text-center">
...
<?php endif; ?>
<?php if (isset($_GET["id"]) AND strpos($_GET["id"], "img-error") != false): ?>
<div>
	<div class="alert alert-danger" role="alert">
	  <div class="text-center">
	      Error de subida de imagen, vuelva a intentarlo (jpg, png, jpeg) 1mb maximo.
	  </div>                 
	</div>
</div>
<?php endif; ?>
